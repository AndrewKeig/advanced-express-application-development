...
this["visiontemplates"]["templates/header.hbs"] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  var buffer = "", stack1, functionType="function", escapeExpression=this.escapeExpression;


  buffer += "<div class=\"navbar-inner\">\n  <div class=\"container-fluid\">\n    <a class=\"brand\" href=\"#\"><img src=\"/vision/airasoul.png\"></a>\n    <div class=\"nav-collapse collapse pull-right\">\n      <p class=\"navbar-text\">\n        sign <a href=\"/logout\" class=\"navbar-link\">";
  ...
  buffer += escapeExpression(stack1)
    + "</a> out\n      </p>\n      <ul class=\"nav\">\n        <li class=\"active\"><a href=\"/auth/github\"><img src=\"/vision/github.png\" id='login'></a>\n        </li>\n      </ul>\n    </div>\n  </div>\n</div>";
  return buffer;
  });
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<form class=\"form-inline\">\n  <ul class=\"errors help\"></ul> \n  <input class=\"name\" placeholder=\"project name\" required=\"required\" value=\"";
